...
const SlideCard = ({key, title, description, img, handle}) => {
  return (
    <div key={key}>
        <div  className='grid sm:grid-cols-2 items-center justify-center'>
            <div className='flex flex-col w-[80%] mx-auto justify-center items-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 '>
                ...
                <button onClick={handle} data-aos="slide-up" data-aos-delay="200" data-aos-duration="500" className='gradient hover:scale-105 duration-200 text-white px-4 py-2 rounded-full'>Order Now</button>
            </div>
